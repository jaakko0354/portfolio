...
const Projects = forwardRef<HTMLDivElement, ProjectsProps> (({ scrollY }, ref) => {
    ...
    return (
        <div className="projects-container" style={{opacity: projectsOpacity(), transform: `translateY(-${projectsTranslateY}px)`}} ref={ref}>
            ...
            <div className="projects">
                <div className="project">
                    ...
                    <div className="project-description">
                        <p>
                            This website is built with React and TypeScript. The website is hosted on GitHub Pages and the source code can be found on my GitHub.
                        </p>
                    </div>
                </div>
            </div>
